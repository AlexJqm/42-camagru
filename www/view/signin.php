...
<div class="container">
	<form class="form-signin" action="" method="POST" enctype="multipart/form-data">
		...
		<button class="btn btn-lg btn-warning btn-block" name="login" type="submit">Se connection</button>
		<p class="mt-5 text-muted">&copy; 2017-2019</p>
		<p class="text-muted"><a href="index.php?forget_password" class="text-warning">Mot de passe oublié?<a></p>
	</form>
</div>
