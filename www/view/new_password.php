<?php require_once('function/change_password.php'); ?>
...
<div class="container">
	<form class="form-signin" action="" method="POST">
		...
		<h1 class="h3 mb-3 font-weight-normal">Réinitialiser</h1>
		<label class="sr-only">Nouveau mot de passe</label>
		<input type="password" name="password" class="form-control bg-dark text-white border border-dark mb-2 rounded" placeholder="Mot de passe" required>
		<label class="sr-only">Confirmation mot de passe</label>
		<input type="password" name="password2" class="form-control bg-dark text-white border border-dark mb-2 rounded" placeholder="Confirmation" required>
		<button class="btn btn-lg btn-warning btn-block" name="new_password" type="submit">Réinitialiser</button>
	</form>
