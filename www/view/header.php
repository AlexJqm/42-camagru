<nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="margin-bottom: 50px; height: 70px;">
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		...
		<ul class="navbar-nav">
			<li class="nav-item dropdown mr-2">
				<a class="nav-link dropdown-toggle btn btn-dark text-secondary" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
					Mon compte
				</a>
		...
		<form class="form-inline my-2 my-lg-0" action="" method="GET">
			<input class="form-control bg-dark mr-sm-2" type="search" placeholder="Recherche" name="search">
