...
<div class="container">
	<form class="form-signin" action="" method="POST">
		...
		<input type="text" name="username" class="form-control bg-dark text-white border border-dark mb-2" placeholder="Pseudonyme" required autofocus>
		...
		<input type="password" name="password" class="form-control bg-dark text-white border border-dark rounded" placeholder="Mot de passe" required>
		<label class="sr-only">Password</label>
		<input type="password" name="password2" class="form-control bg-dark text-white border border-dark rounded" placeholder="Confirmation mot de passe" required>
		<button class="btn btn-lg btn-warning btn-block" name="register" type="submit">S'inscrire</button>
